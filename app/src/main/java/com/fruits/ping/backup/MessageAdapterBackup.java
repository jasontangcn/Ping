...
import com.fruits.ping.MediaManager;
import com.fruits.ping.R;
import com.fruits.ping.utils.MiscUtil;

import java.util.ArrayList;
import java.util.List;

public class MessageAdapterBackup extends BaseAdapter {
  List<AudioRecordBackup> audioRecords;
  Context context;
  List<AnimationDrawable> animations;
  int pos = -1;//标记当前录音索引，默认没有播放任何一个

  public MessageAdapterBackup(Context context, List<AudioRecordBackup> records) {
